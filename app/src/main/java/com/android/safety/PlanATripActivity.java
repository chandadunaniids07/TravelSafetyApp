...
import com.android.safety.databinding.ActivityPlanATripBinding;
...
public class PlanATripActivity extends AppCompatActivity {
    ...
    private ActivityPlanATripBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityPlanATripBinding.inflate(getLayoutInflater());
    ...
    private void sendRequest(String url, JSONObject json) {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                MyRecyclerViewAdapter myRecyclerViewAdapter = new MyRecyclerViewAdapter(featureData, PlanATripActivity.this);
